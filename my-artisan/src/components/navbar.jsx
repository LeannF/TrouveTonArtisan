                ...
                <div className="row">
                    ...
                    <div className="col-4 collapse navbar-collapse " id="navbarText">  
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0 ">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link active" href="/">Fabrication</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link active" href="/">Alimentation</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link active" href="/">Bâtiment</Link>
                            </li>
                        </ul>
                    </div>
